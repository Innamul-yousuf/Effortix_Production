 ...
 * 
 * import com.effortix.backend.models.Employee; import
 * com.effortix.backend.models.PrimePicks; import
 * com.effortix.backend.models.Ticket; import
 * com.effortix.backend.services.EmployeeService; import
 * com.effortix.backend.services.PrimePicksService; import
 * com.effortix.backend.services.TicketService;
 * 
 * import org.springframework.beans.factory.annotation.Autowired; import
 * org.springframework.stereotype.Controller; import
 * org.springframework.ui.Model; import
 ...
 * import java.util.List;
 * 
 * //@Controller //@RequestMapping("/primepicks") public class
 * PrimePicksController {
 * 
 * @Autowired private PrimePicksService primePicksService;
 * 
 * 
 ...
 * 
 * @GetMapping("/primepicks/create") public String showCreateForm(Model model) {
 * PrimePicks primePicks = new PrimePicks(); model.addAttribute("primePicks",
 * primePicks); return "primePicksUI/create"; // Render the Thymeleaf form }
 * 
 * 
 ...
 * 
 * 
 * @GetMapping("/active") public String getActivePrimePicks(Model model) {
 * List<PrimePicks> primePicksList = primePicksService.getActivePrimePicks();
 * model.addAttribute("primePicksList", primePicksList); return
 * "primePicksUI/active"; // This corresponds to active.html }
 * 
 * 
 * // Save the claimed task as a ticket
 * 
 * @PostMapping("/save") public String saveTicket2(@RequestBody Ticket ticket) {
 * System.out.println("Ticket: " + ticket.getTName());
 * System.out.println("Assigned to: " + ticket.getToEmployee().geteEmail());
 * 
 * // Save the ticket Ticket savedTicket =
 * ticketService.saveOrUpdateTicket(ticket);
 * 
 * // Trigger an email or any additional functionality you need //EMAILLLLLLLL
 * 
 * System.out.println("Ticket saved."); return "redirect:/tickets"; // Redirect
 * to the tickets page } }
 */