...
public class GenerateFunFridayTask {
	...
	public List<Ticket> generateFunFridayTask() {
		try {
			...
			String systemInstruction="You are an AI assistant responsible for generating fun Friday tasks like professional dares for the IT Employees. It should be like a fun filled fun friday tasks in format of tickets. You can generate a maximum 5 task with a breaf description about the task, task name, links if any and online reference files if any. It should be innovative and funfilled and can be done in an office Environment. Please only give the details of the task in json format and not any other instruction about the your respose. The Json must have taskName, description, link(Empty), referenceFile(Empty), deadline as the comming friday date"
